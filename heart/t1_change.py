...
def extract_heart_signal(received_signal,  sample_rate, cutoff_frequency, start_time, end_time):
    ...
    filtered_signal = low_pass_filter(received_signal, cutoff_frequency, sample_rate)
    return filtered_signal


def echo(file_path, cutoff_frequency, plot_title):
    ...
    '''
    heart_signal = extract_heart_signal(received_signal, sample_rate, cutoff_frequency, start_time,
                                        end_time)
